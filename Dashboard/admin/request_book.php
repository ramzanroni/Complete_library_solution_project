...
{
  $issue_id=$_GET['accept'];
  $action='accept';
  $sql_decactive=$conn->query("UPDATE  issue_books SET  status='accept',  issue_date='$date' WHERE  issue_id='$issue_id'");
  if ($sql_decactive==true) 
  {
    echo "<script>
            alert('Update Successful...!');
            document.location = 'request_book.php';
            </script>";
  }
  else
  {
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php
              $sql=$conn->query("SELECT * FROM issue_books WHERE status='panding' order by id DESC");
              while ($row=mysqli_fetch_array($sql))
              {
                ...
                <tr>
                  ...
                  <td><a class="btn btn-info" href="request_book.php?accept=<?php echo $row['issue_id']; ?>">Accept Request</a></td>
