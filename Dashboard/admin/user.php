...
{
  $deactive_id=$_GET['active'];
  $status=0;
  $sql_decactive=$conn->query("UPDATE  tbl_users SET  status='0' WHERE id='$deactive_id'");
...
if (isset($_GET['deactive'])) 
{
  ...
  $status=0;
  $sql_decactive=$conn->query("UPDATE  tbl_users SET  status='1' WHERE id='$deactive_id'");
  if ($sql_decactive==true) 
  {
    echo "<script>
    alert('Update Successful...!');
...
$sql_user=$conn->query("SELECT * FROM")
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <table class="table table-bordered table-hover" style="overflow-x: scroll" id="employee_data">
              ...
              <?php
              $sql=$conn->query("SELECT * FROM tbl_users order by id DESC");
