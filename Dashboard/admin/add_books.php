            ...
            <div class="col-md-12">
              <?php
                ...
                if(isset($_POST['submit']))
                {
                  ...
                  if(!isset($errMSG))
                  {
                      $query="INSERT INTO books(name, author, edition, status, quantity, department, image, base_quantity) values ('$name', '$author', '$edition', '$status', '$quantity', '$dept', '$userpic', '$quantity')";
                      $result=$conn->query($query);

                      if ($result) {
                        ?>
                            echo "<script>
			                     alert('New Book Add Successful...!');
              ...
              ?>
              <p class="h2 text-center">Add A New Books</p>
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="au_name" class="form-control">
                </div>
                <div class="form-group">
                  <label>Edition</label>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="book_qun" class="form-control">
                </div>
                <div class="form-group">
