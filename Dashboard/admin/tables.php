                    ...
                    <?php 
                        while ($row=mysqli_fetch_array($books)) {
                          ...
                          <tr>
                              ...
                              <td><img style="width: 100px; height: 100px;" src="img/<?php echo $row['image']; ?>"></td>
                              <td><a href=edit_book.php?edit=<?php echo $row['id']; ?> onclick="return confirm('Are you sure.... ??')" class="text-info"><i class="material-icons">edit</i></a></td>
                              <td><a href="?del=<?php echo $row['id'];?>" onclick="return confirm('Are you sure.... ??')" class="text-warning"><i class="material-icons">delete_forever</i></a></td>
                          </tr>
                          <?php
                        }
